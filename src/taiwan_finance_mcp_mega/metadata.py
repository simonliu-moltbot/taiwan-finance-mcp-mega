...
TOOL_METADATA = {
    ...
    "get_stock_institutional_summary_twse": { "summary": "[上市/大盤] 查詢證交所 (TWSE) 三大法人於大盤現貨市場之買賣超合計。用於看大盤總額，非個股。", "inputs": "None", "outputs": "買賣超金額。", "source": "TWSE" },
    "get_stock_institutional_details_tpex": { "summary": "[上櫃/櫃買] 查詢櫃買市場 (TPEx) 個別股票之法人買賣超明細。用於看每支股票進出。", "inputs": "ticker: 股票代碼。", "outputs": "買賣超金額。", "source": "TPEx" },
    "get_stock_institutional_summary_tpex": { "summary": "[上櫃/櫃買] 查詢櫃買中心 (TPEx) 三大法人於上櫃市場之買賣超合計。用於看上櫃總額，非個股。", "inputs": "None", "outputs": "合計買賣超。", "source": "TPEx" },
