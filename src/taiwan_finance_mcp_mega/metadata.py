...
TOOL_METADATA = {
    ...
    "get_stock_institutional_investor_flow": { "summary": "[上市/大盤] 查詢證交所 (TWSE) 三大法人於股票現貨市場之買賣超彙總統計。專指上市股票。", "inputs": "None", "outputs": "買賣超金額。", "source": "TWSE" },
    "get_stock_institutional_trading_tpex": { "summary": "[上櫃/櫃買] 查詢三大法人於櫃買市場 (TPEx) 之個別股票買賣超明細。", "inputs": "ticker: 股票代碼。", "outputs": "買賣超金額。", "source": "TPEx" },
    "get_stock_institutional_summary_tpex": { "summary": "[上櫃/櫃買] 查詢櫃買中心 (TPEx) 三大法人於上櫃股票市場之買賣超彙總統計。", "inputs": "None", "outputs": "合計買賣超。", "source": "TPEx" },
