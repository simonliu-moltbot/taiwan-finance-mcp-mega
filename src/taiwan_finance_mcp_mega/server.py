...
MEGA_ENDPOINT_MAP = {
    ...
    "get_stock_institutional_summary_twse": "https://www.twse.com.tw/rwd/zh/fund/BFI82U?response=json",
    "get_stock_institutional_details_tpex": "/v1/tpex_3insti_daily_trading",
    ...
    "get_stock_individual_average_price": "/exchangeReport/STOCK_DAY_AVG_ALL",
...
async def dispatch_mega_logic(name: str, query_val: Optional[str], limit: int) -> Any:
    try:
        ...
        # 2. 全球匯率與大宗路由
            ...
            if "gold_spot" in name: return await StockLogic.call_generic_api("/v1/tpex_gold_latest", None)
