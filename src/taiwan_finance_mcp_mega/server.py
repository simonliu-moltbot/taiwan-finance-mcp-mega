...
# Absolute Logic Imports for Docker Compatibility
...
def main():
    parser = argparse.ArgumentParser(description=f"Taiwan Finance MCP Mega v2.7.6 (Total Tools: {TotalRegistered})")
    ...
    if args.mode == "stdio":
        ...
        print(f"啟動 {Config.APP_NAME} v2.7.6 [Total Tools: {TotalRegistered}] 於 HTTP 模式...", file=sys.stderr)
        mcp.run(
